...
public class NERTrainingExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            in = new MarkableFileInputStreamFactory(new File("/Users/user/temp/trainingDataSet.txt"));
        }
        ...
        try {
            nameFinderModel = NameFinderME.train(
                    "en",
                    null,
                    sampleStream,
                    params,
        ...
        // testing the model and printing the types it found in the input
        // sentence
        TokenNameFinder nameFinder = new NameFinderME(nameFinderModel);

        String[] testSentence = { "five", "bedroom", "apartments", "in", "Mumbai" };
